...
public class EmptyBot {
	...
	public static void DoTurn(PlanetWars pw) {
		...
		// notice that a PlanetWars object called pw is passed as a parameter
		// which you could use
		// if you want to know what this object does, then read PlanetWars.java

		// create a source planet, if you want to know what this object does,
		// then read Planet.java
		Planet source = null;
